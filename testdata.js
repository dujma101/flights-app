...
var stateList = [];
b.states.forEach(function (params) {
   
  stateList.push(params[2]);
...
countedByState = count(stateList);


keysSorted = Object.keys(countedByState).sort(function(a,b){return countedByState[b]-countedByState[a]})

   console.log( countedByState);

console.log(keysSorted);

let entries = Object.entries(countedByState);
